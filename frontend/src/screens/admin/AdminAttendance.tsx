  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Total Employees" value="248" icon={Users} color="blue" />
        <StatCard title="Present Today" value="215" icon={CheckCircle} color="green" />
        <StatCard title="Absent" value="28" icon={XCircle} color="red" />
        <StatCard title="Late Entries" value="5" icon={Clock} color="yellow" />
      </div>

      {/* Table */}
      <div className="bg-white rounded-xl border border-gray-200">
        <div className="p-6 border-b border-gray-200 flex items-center justify-between">
          <h3 className="text-lg font-semibold text-gray-900">Attendance Records - Today</h3>
